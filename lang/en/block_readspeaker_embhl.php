<?php
/**
 * Strings for component 'block_readspeaker_embhl', language 'en'
 *
 ...
 */
    ...
    $string['headerconfig'] = 'Configuration Options';
    $string['descconfig'] = 'Below you will find the configuration options available for the ReadSpeaker webReader plugin.';
    $string['defaultblocktitle'] = 'Listen to this page using ReadSpeaker';
    $string['blocksettings'] = 'Configure ReadSpeaker webReader';

    // CustomerID
    $string['customerid'] = 'Customer ID (required)';
    $string['desccustomerid'] = 'Your ReadSpeaker Customer ID (example "1234").';

    // Language
    $string['lang'] = 'Language (required)';
    $string['desclang'] = 'Select the language for your ReadSpeaker installation (the selected language must be enabled in your ReadSpeaker account).';

    // Language
    $string['region'] = 'Region';
    $string['descregion'] = 'Select the region for your ReadSpeaker installation.';

    // wR version
    $string['wrversion'] = 'Version name';
    $string['descwrversion'] = 'Enter version name (as specified in instructions).';

    // Readid
    $string['readid'] = 'ReadID (required)';
    $string['descreadid'] = 'The ID of the div which is to be read (example "region-main").';

    // DocReader
    $string['textdocreaderenabled'] = 'DocReaderID';
    $string['desctextdocreaderenabled'] = 'Enter your DocReaderID in order to enable DocReader in Moodle (DocReader must be enabled in your ReadSpeaker account). Leave blank to disable.';

    // Custom parameters
    $string['textcustomparams'] = 'Advanced option: Custom parameters';
    $string['desctextcustomparams'] = 'Specify custom parameters to the ReadSpeaker Listen button (adds in addition to default).';

    // Custom JavaScript
    $string['textcustomjavascript'] = 'Advanced option: Custom JavaScript link';
    $string['desctextcustomjavascript'] = 'Specify a custom JavaScript link to use for the ReadSpeaker JavaScript (overwrites default).';
	
	// Player placement
	$string['showincontent'] = 'Listen button placement';
    $string['descshowincontent'] = 'The Listen button is by default placed in a block in the sidebar. You can move the player to the top of the content instead.';
